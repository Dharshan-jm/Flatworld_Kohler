...
public class TC_05_VerifyUserShouldNotRedeemPointsLessThen4Test extends BaseClass{
	...
	@Test
	public void verifyUserShouldNotRedeemPointsLessThen5() throws InterruptedException {
			...
			driver.findElement(By.xpath("//div/input[contains(@placeholder,'Enter points')]")).sendKeys(numberValue);
	        webDriverUtility.waitForSeconds(2);
