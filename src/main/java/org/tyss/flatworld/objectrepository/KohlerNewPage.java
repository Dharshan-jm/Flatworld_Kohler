...
public class KohlerNewPage {
	...
	//Business method for curriculum Name
	public WebElement curriculumNameTest(String curriculumName) {
		return driver.findElement(By.xpath("//h3[text()='"+curriculumName+"']"));
	}
    
	public WebElement courseNameTest(String courseName) {
		return driver.findElement(By.xpath("//h3[text()='"+courseName+"']"));
	}
}
